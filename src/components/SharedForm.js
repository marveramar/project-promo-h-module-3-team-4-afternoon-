            ...
            <fieldset className="fieldset fieldset__share">
                ...
                <div className={`share  ${this.props.isVisible === 'shareContainer' ? '' : 'hidden'}`} id="share">
                    <div className="create_card">
                        <button disabled={this.props.isDisabled} onClick={this.handleApiFetch} type="submit" value="submit" id="createCardButton" className="create_card-btn"><i
                            className="far fa-address-card"> CREAR TARJETA</i></button>
                        <ErrorMessage
                            id="error-name-job"
                            errorText='Faltan campos por completar'
